          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", console.log("Email is required"));

              case 2:
                if (_this.data.password.trim() == "") console.log("Password is required");
                if (_this.data.password.length < 6) console.log("Incorrect login details");
                _this.isLogging = true;
                _context.next = 7;
                return _this.axios.post("/api/admin_login", _this.data);
              ...
              case 7:
                ...
                if (res.status === 200) {
                  ...
                  if (res.status === 401) {} else if (res.status == 422) {
...
var render = function () {
  ...
  return _c(
    ...
    [
      ...
      _c("br"),
      _vm._v(" "),
      _c("div", { staticClass: "container card w-50" }, [
        _c("div", { staticClass: "card-body row align-items-center" }, [
          _c("form", [
